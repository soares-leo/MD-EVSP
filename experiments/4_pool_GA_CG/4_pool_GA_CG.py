...
def run_cg_ga(i):
    ...
    final_df.to_csv(f"experiments/4_pool_GA_CG/reports/4_pool_GA_CG_{i}.csv", index=False)

    if nonzero_cols:
        file_path = f"experiments/4_pool_GA_CG/solutions/4_pool_GA_CG_GA_{i}.json"
