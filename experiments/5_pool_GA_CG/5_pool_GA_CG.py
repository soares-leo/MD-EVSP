...
def run_cg_ga(i):
    ...
    final_df.to_csv(f"experiments/5_pool_GA_CG/reports/5_pool_GA_CG_20Q_09theta_mipFalse_{i}.csv", index=False)

    if nonzero_cols:
        file_path = f"experiments/5_pool_GA_CG/solutions/5_pool_GA_CG_20Q_09theta_mipFalse_{i}.json"
