...
class InstanceGenerator:
    ...
    def generate_instance(self):
        ...
        generated_timetables = [generate_timetable_v3(self.lines_info, **configs) for configs in self.trips_configs]
        end_time = time.time()
        ...
        # Call the new function to apply the transformations
        self.timetables = post_process_timetable(self.timetables, self.lines_info)
        # --- END OF NEW STEP ---
...
class SolutionGenerator:
    ...
    def refresh_data(self):
        ...
        # print("time:", self.time)
        # print("dh_dist_ij:", dh_dist_ij)
        # print("dh_time_ij:", dh_time_ij)
    ...
    def update_route(self, ti=None):
        ...
        # print("--------- pred check --------")
        # print("tj.departure_time:", tj.departure_time)
        # print("self.current_time:", self.current_time)
        # print("tij_time:", tij_time)
